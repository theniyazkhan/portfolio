    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 w-full">
      ...
      >
        ...
        <div class="px-2 flex flex-col flex-1">
          ...
          <!-- View details & direct link CTAs -->
          <div class="flex items-center justify-between gap-2 mt-auto pt-3 border-t border-slate-100 dark:border-slate-800/80">
            <button
              @click.stop="openModal(project)"
              class="group/link inline-flex items-center gap-1.5 text-xs font-bold text-violet-600 dark:text-violet-400 hover:gap-2 transition-all duration-300 cursor-pointer"
            >
              View Details
            ...
            <div class="flex items-center gap-1.5 shrink-0">
              <a
                ...
                @click.stop
                class="px-2.5 py-1 bg-violet-600 hover:bg-violet-700 text-white rounded-lg text-xs font-bold transition-all flex items-center gap-1 shadow-sm"
              ...
              <a
                ...
                rel="noopener noreferrer"
                @click.stop
                class="p-1.5 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800"
        ...
        >
          ...
          >
              ...
              <div class="w-full max-w-2xl mt-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2.5 shrink-0">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="px-4 py-2 bg-slate-200 hover:bg-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-900 dark:text-white rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow"
                  >
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                      <path fill-rule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clip-rule="evenodd" />
                    </svg>
            ...
            <div class="p-6 sm:p-8 overflow-y-auto space-y-8">
              ...
              <div class="space-y-3">
                <h4 class="text-xs sm:text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">
                  About The Project
                </h4>
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-2 space-y-4">
                  <h4 class="text-xs sm:text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest flex items-center gap-2">
                    <svg class="w-4 h-4 text-violet-500 dark:text-violet-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                  ...
                  <ul class="space-y-2.5">
                    <li
                      ...
                      :key="feat"
                      class="flex items-start gap-2.5 text-xs sm:text-sm text-slate-700 dark:text-slate-200 leading-relaxed"
                    >
                      <span class="w-1.5 h-1.5 bg-violet-500 dark:bg-violet-400 rounded-full mt-2 shrink-0"></span>
                      <span>{{ feat }}</span>
                    </li>
                  </ul>
                </div>
